...
int main(int argc, char* argv[])
{
	...
	TargetPt targetdata[user] = { {0, 35.1344634, 129.1060115}, {1, 35.1344634, 129.1060115 },
	{2, 35.134446, 129.1051705 }, {3, 35.134446, 129.1051705 }, {4, 35.134446, 129.1051705 }};
...
void takeInput(int points, double cordinates[user][user])      // villages : service requesting user number, cordinates : TSP 2dimension array by using point
{
	int i, j;
	int n = points;
